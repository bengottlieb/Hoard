...
SWIFT_CLASS("_TtC10GulliverUI22FullScreenBlockingView")
@interface FullScreenBlockingView : UIView
@property (nonatomic, copy) void (^ _Nullable dismissClosure)(void);
+ (FullScreenBlockingView * _Nullable)blockerForViews:(NSArray<UIView *> * _Nonnull)targets closure:(void (^ _Nullable)(void))closure;
...
SWIFT_CLASS("_TtC10GulliverUI24NetworkActivityIndicator")
@interface NetworkActivityIndicator : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) NetworkActivityIndicator * _Nonnull sharedIndicator;)
+ (NetworkActivityIndicator * _Nonnull)sharedIndicator;
...
@interface UITextField (SWIFT_EXTENSION(GulliverUI))
@end


@interface UIViewController (SWIFT_EXTENSION(GulliverUI)) <UITextFieldDelegate>
@end

@class UINavigationController;

@interface UIViewController (SWIFT_EXTENSION(GulliverUI))
...
+ (UIViewController * _Nullable)frontmostController;
...
@interface UIWindow (SWIFT_EXTENSION(GulliverUI))
+ (UIWindow * _Nullable)rootWindow;
@end
