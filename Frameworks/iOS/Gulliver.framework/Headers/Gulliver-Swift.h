...
SWIFT_CLASS("_TtC8Gulliver23AttributedTableViewCell") SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface AttributedTableViewCell : UITableViewCell
- (void)awakeFromNib;
- (void)didMoveToSuperview;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=9.0);
...
- (void)screenEdgePannedWithRecog:(UIScreenEdgePanGestureRecognizer * _Nonnull)recog;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


@interface ContainerViewController (SWIFT_EXTENSION(Gulliver))
@property (nonatomic, readonly, strong) UIViewController * _Nonnull visibleContainedController;
@end
...
@interface UITabBarController (SWIFT_EXTENSION(Gulliver))
@property (nonatomic, readonly, strong) UIViewController * _Nonnull visibleContainedController;
@end
