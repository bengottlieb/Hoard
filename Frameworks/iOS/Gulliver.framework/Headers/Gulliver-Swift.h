...
+ (AttributedTableViewCell * _Nonnull)attributedCellWithReuseIdentifier:(NSString * _Nullable)reuseIdentifier insets:(UIEdgeInsets)insets SWIFT_WARN_UNUSED_RESULT;
- (void)awakeFromNib;
...
- (UIImage * _Nullable)imageWithNamed:(NSString * _Nonnull)named compatibleWith:(UITraitCollection * _Nullable)compatibleWith SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, readonly, copy) NSString * _Nonnull copyright;
@end
...
- (BOOL)fileNotDirectoryExistsAt:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, copy) NSURL * _Nullable modelURL;
@property (nonatomic, strong) NSManagedObjectModel * _Null_unspecified model;
@property (nonatomic, strong) NSPersistentStoreCoordinator * _Null_unspecified persistentStoreCoordinator;
@property (nonatomic, strong) NSManagedObjectContext * _Null_unspecified mainThreadContext;
@property (nonatomic, strong) NSManagedObjectContext * _Null_unspecified privateContext;
@property (nonatomic, copy) NSString * _Nullable groupIdentifier;
@property (nonatomic, copy) NSURL * _Null_unspecified storeURL;
@property (nonatomic, copy) NSURL * _Null_unspecified databaseURL;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nonnull persistentStoreOptions;
@property (nonatomic, readonly) BOOL databaseFileExists;
@property (nonatomic, readonly) BOOL dataDirectoryExists;
@property (nonatomic, readonly) BOOL isSetup;
- (nonnull instancetype)initWithDbFilename:(NSString * _Nonnull)dbFilename modelURL:(NSURL * _Nullable)modelURL groupIdentifier:(NSString * _Nullable)groupIdentifier options:(NSDictionary<NSString *, id> * _Nonnull)options OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) NSString * _Null_unspecified databaseName;
@property (nonatomic, readonly, copy) NSString * _Nullable nominalDatabaseName;
@property (nonatomic, readonly, copy) NSURL * _Nullable nominalDatabaseURL;
@property (nonatomic, copy) NSString * _Nonnull dbFilenameBase;
@property (nonatomic) BOOL savingMetadata;
- (NSString * _Nonnull)buildDatabaseNameFrom:(NSString * _Nonnull)base SWIFT_WARN_UNUSED_RESULT;
- (void)setup;
- (void)setupModel;
...
- (BOOL)switchDatabaseNameTo:(NSString * _Nonnull)newName error:(NSError * _Nullable * _Nullable)error;
...
- (void)clearMetadata;
- (void)removeDatabaseFileWithCompletion:(void (^ _Nullable)(void))completion;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


@interface ManagedObjectStore (SWIFT_EXTENSION(Gulliver))
- (void)registerWithContext:(NSManagedObjectContext * _Nonnull)context;
- (void)unregisterWithContext:(NSManagedObjectContext * _Nullable)context;
@end
...
- (CGFloat)heightWithConstrainedToWidth:(CGFloat)constrainedToWidth SWIFT_WARN_UNUSED_RESULT;
@end
...
- (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)fetchWithFields:(NSArray<NSString *> * _Nonnull)fields from:(NSString * _Nonnull)entityName matching:(NSPredicate * _Nullable)predicate SWIFT_WARN_UNUSED_RESULT;
- (NSArray * _Nonnull)fetchWithField:(NSString * _Nonnull)field from:(NSString * _Nonnull)entityName matching:(NSPredicate * _Nullable)predicate SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)appendWithImage:(UIImage * _Nullable)image scaledToCurrentSize:(BOOL)scaledToCurrentSize;
@end
...
+ (NSMutableParagraphStyle * _Nonnull)alignedWithAlignment:(NSTextAlignment)alignment SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) NSParagraphStyle * _Nonnull centered;)
+ (NSParagraphStyle * _Nonnull)centered SWIFT_WARN_UNUSED_RESULT;
@end


@interface NSPersistentStore (SWIFT_EXTENSION(Gulliver))
- (void)removeFile;
@end
...
@property (nonatomic) double fractionCompleted;
@property (nonatomic) BOOL indeterminate;
- (ProgressDisplay * _Nonnull)close:(BOOL)animated completion:(void (^ _Nullable)(void))completion SWIFT_WARN_UNUSED_RESULT;
- (void)progressDisplayBegan;
- (void)progressDisplayCompleted;
...
- (UILabel * _Nonnull)labelWithFontOfSize:(CGFloat)size text:(NSString * _Nonnull)text SWIFT_WARN_UNUSED_RESULT;
...
+ (ProgressDisplayManager * _Nonnull)defaultManager SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, strong) UIViewController * _Nullable presentedByController;
...
+ (NSInteger)numberOfPendingAlerts SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (BOOL)isPointExcluded:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
- (void)tapped;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, strong) UIView * _Nonnull view;
@property (nonatomic, readonly) BOOL isIndeterminateDisplay;
+ (UIActivityIndicatorView * _Nonnull)progressDisplay SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (UIBarButtonItem * _Nonnull)flexibleSpacer SWIFT_WARN_UNUSED_RESULT;
...
- (void (^ _Nullable)(UIControl * _Nonnull))blockForEvent:(UIControlEvents)event SWIFT_WARN_UNUSED_RESULT;
...
- (CGSize)sizeOfStringWithString:(NSString * _Nonnull)string constrainedToWidth:(CGFloat)width SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (UIImage * _Nullable)createWithSize:(CGSize)size closure:(SWIFT_NOESCAPE void (^ _Nonnull)(CGContextRef _Nonnull))closure SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)tintedImageWithTint:(UIColor * _Nonnull)tint SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nonnull)scaledImageWithScale:(CGFloat)scale SWIFT_WARN_UNUSED_RESULT;
+ (UIImage * _Nullable)deviceLaunchImageWithOrientation:(UIDeviceOrientation)orientation SWIFT_WARN_UNUSED_RESULT;
+ (NSURL * _Nullable)deviceLaunchImageURLWithOrientation:(UIDeviceOrientation)orientation SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) BOOL hasAlpha;
@end


@interface UIImageView (SWIFT_EXTENSION(Gulliver))
+ (UIImageView * _Nullable)deviceLaunchImageViewWithOrientation:(UIInterfaceOrientation)orientation SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, readonly, strong) UIView * _Nonnull view;
@property (nonatomic, readonly) BOOL isIndeterminateDisplay;
+ (UIProgressView * _Nonnull)progressDisplay SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)constrainDimension:(NSLayoutAttribute)attribute constant:(CGFloat)constant priority:(UILayoutPriority)priority relation:(NSLayoutRelation)relation;
...
+ (UIView * _Nullable)viewWithNibName:(NSString * _Nullable)nibName bundle:(NSBundle * _Nullable)bundle SWIFT_WARN_UNUSED_RESULT;
...
- (UIView * _Nonnull)blockingViewWithExcluding:(NSArray<NSValue *> * _Nonnull)excluding tappedClosure:(void (^ _Nullable)(void))closure SWIFT_WARN_UNUSED_RESULT;
...
- (NSString * _Nonnull)hierarchy:(NSString * _Nullable)prefix SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isAncestorWithView:(UIView * _Nullable)view SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (UIViewController * _Nullable)fromStoryboard:(NSString * _Nullable)name bundle:(NSBundle * _Nullable)bundle SWIFT_WARN_UNUSED_RESULT;
@end

@class UITextField;

@interface UIViewController (SWIFT_EXTENSION(Gulliver))
+ (nonnull instancetype)fromXIB:(NSString * _Nullable)nibName bundle:(NSBundle * _Nullable)bundle SWIFT_WARN_UNUSED_RESULT;
+ (nonnull instancetype)controller SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nullable)nibName SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nullable storyboardName;)
+ (NSString * _Nullable)storyboardName SWIFT_WARN_UNUSED_RESULT;
...
@interface UIViewController (SWIFT_EXTENSION(Gulliver))
@property (nonatomic, readonly, strong) UIViewController * _Nonnull container;
...
+ (NSSet<NSString *> * _Nonnull)loading SWIFT_WARN_UNUSED_RESULT;
+ (void)setLoading:(NSSet<NSString *> * _Nonnull)value;
+ (XibHostedView * _Nullable)fromXIB SWIFT_WARN_UNUSED_RESULT;
- (UIView * _Nullable)replaceFromXib SWIFT_WARN_UNUSED_RESULT;
