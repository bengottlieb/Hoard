...
+ (FullScreenBlockingView * _Nonnull)blockerForViews:(NSArray<UIView *> * _Nonnull)targets closure:(void (^ _Nullable)(void))closure;
...
+ (UIAlertController * _Nonnull)showAlert:(NSError * _Nonnull)error title:(NSString * _Nonnull)title;
+ (UIAlertController * _Nonnull)showAlert:(NSString * _Nonnull)title message:(NSString * _Nullable)message buttons:(NSArray<NSString *> * _Nonnull)buttons block:(void (^ _Nonnull)(NSInteger))block;
+ (void)showNextPendingController;
- (void)present;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidDisappear:(BOOL)animated;
- (void)cancel:(BOOL)animated completion:(void (^ _Nullable)(void))completion;
