...
+ (SoundEffect * _Nullable)soundEffectFrom:(NSURL * _Nonnull)url;
+ (SoundEffect * _Nullable)preflightWithName:(NSString * _Nonnull)name;
+ (BOOL)playWithSoundNamed:(NSString * _Nonnull)name;
...
SWIFT_CLASS("_TtC8Gulliver8WAVSound")
@interface WAVSound : SoundEffect
@property (nonatomic, readonly, copy) NSURL * _Null_unspecified url;
...
SWIFT_CLASS("_TtC8Gulliver9AIFFSound")
...
SWIFT_CLASS("_TtC8Gulliver8CAFSound")
@interface CAFSound : SoundEffect
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) SystemSoundID soundIDCount;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSURL * _Nullable storeDirectoryURL;)
...
+ (void)setAppGroupIdentifierWithIdentifier:(NSString * _Nonnull)identifier filename:(NSString * _Nullable)filename;
...
- (void)importBlockWithBlock:(void (^ _Nonnull)(NSManagedObjectContext * _Nonnull))block;
...
- (NSManagedObject * _Nullable)objectInContextWithMoc:(NSManagedObjectContext * _Nonnull)moc;
- (void)log;
...
- (NSInteger)countWithEntity:(NSString * _Nonnull)entity predicate:(NSPredicate * _Nullable)predicate;
...
- (NSFetchRequest<id <NSFetchRequestResult>> * _Nonnull)fetchRequestWithName:(NSString * _Nonnull)name;
- (NSManagedObject * _Nullable)insertObjectWithNamed:(NSString * _Nonnull)entityName;
- (NSArray<NSManagedObject *> * _Nonnull)allWithNamed:(NSString * _Nonnull)entityName predicate:(NSPredicate * _Nullable)predicate sortedBy:(NSArray<NSSortDescriptor *> * _Nonnull)sortedBy;
- (NSManagedObject * _Nullable)anyObjectNamedWithEntityName:(NSString * _Nonnull)entityName predicate:(NSPredicate * _Nullable)predicate sortBy:(NSArray<NSSortDescriptor *> * _Nonnull)sortBy;
@end
...
+ (void)postWithName:(NSString * _Nonnull)name object:(id _Nullable)object userInfo:(NSDictionary * _Nullable)userInfo;
+ (void)postOnMainThreadWithName:(NSString * _Nonnull)name object:(id _Nullable)object userInfo:(NSDictionary * _Nullable)userInfo;
@end
...
- (void)unregisterWithWatcher:(Watcher * _Nonnull)watcher;
- (void)cleanWithSerialized:(BOOL)serialized;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SoundPlayer * _Nonnull player;)
+ (SoundPlayer * _Nonnull)player;
@property (nonatomic, strong) NSMutableArray * _Nonnull players;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (BOOL)playWAVWithName:(NSString * _Nonnull)name directory:(NSString * _Nullable)directory;
- (BOOL)playWithName:(NSString * _Nonnull)name directory:(NSString * _Nullable)directory;
- (BOOL)playAIFFWithName:(NSString * _Nonnull)name directory:(NSString * _Nullable)directory;
...
+ (UIImage * _Nullable)createWithSize:(CGSize)size closure:(void (^ _Nonnull)(CGContextRef _Nonnull))closure;
- (UIImage * _Nullable)tintedImageWithTint:(UIColor * _Nonnull)tint;
- (UIImage * _Nonnull)scaledImageWithScale:(CGFloat)scale;
- (UIImage * _Nullable)resizedImageWithSize:(CGSize)size trimmed:(BOOL)trimmed;
...
- (void)registerCellClassWithCellClass:(SWIFT_METATYPE(UITableViewCell) _Nonnull)cellClass;
@end
...
@interface UIView (SWIFT_EXTENSION(Gulliver))
+ (UIView * _Nullable)viewWithNibName:(NSString * _Nullable)nibName bundle:(NSBundle * _Nonnull)bundle;
